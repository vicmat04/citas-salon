			...
			<div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-start">
				<section className="space-y-6 pt-6">
					...
					<div className="space-y-3">
						<h1 className="text-4xl font-bold tracking-tight">
							Empieza a gestionar tu salón hoy
						</h1>
						<p className="text-lg text-muted-foreground">
							Crea tu cuenta, recibe tu período de prueba y entra directamente a
							tu panel.
						</p>
					</div>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							La duración y el plan de prueba se asignan de forma segura al
